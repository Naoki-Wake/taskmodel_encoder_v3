...
def transform_to_laban(fp_image, out_dir, vizualize=False):
    ...
    with mp_pose.Pose(static_image_mode=True, 
        ...
        cv2.imwrite(os.path.join(out_dir, 'pose_' + image_basename), annotated_image)
        ...
        print('right_forearm: ', get_laban(vec_right_forearm))
        print('right_upper_arm: ', get_laban(vec_right_upper_arm))
        print('left_forearm: ', get_laban(vec_left_forearm))
        print('left_upper_arm: ', get_laban(vec_left_upper_arm))
