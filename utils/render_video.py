...
import os
import numpy as np
rootdir = '../output_user_interface/hand_allframe/hand_rotation_2/out'
fp_mp4 = '..\\tmp\\hand_rotation_2.mp4'
latel = 'right'
# list of files in directory
file_list = os.listdir(rootdir)
fp_focus = [i for i in file_list if i.startswith(latel) and not i.endswith('_overlay.jpg')]
print(fp_focus)
